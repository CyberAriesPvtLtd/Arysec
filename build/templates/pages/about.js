...
${C.ctaBanner({
  ...
  return {
    path: '/about/',
    title: 'About Us | Arysec Consultancy LLP',
    description:
      'Learn about Arysec Consultancy LLP, a leading IT and cybersecurity consulting firm in Mumbai, providing certified security expertise.',
    content,
    jsonLd: [
