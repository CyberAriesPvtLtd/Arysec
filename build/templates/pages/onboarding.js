          ...
          <form class="contact-form reveal" id="onboardingForm" novalidate>
            ...
            <div class="hr-step-card">
              ...
              <div class="form-row">
                <div class="form-field">
                  ...
                  <input type="text" id="name" name="name" placeholder="First and last name" required maxlength="100" autocomplete="name">
                  <span class="field-error" data-error-for="name"></span>
                </div>
                <div class="form-field">
                  <label for="preferredName">Preferred Name</label>
                  <input type="text" id="preferredName" name="preferredName" placeholder="Name to call you" maxlength="100">
              ...
              <div class="form-row">
                ...
                <div class="form-field">
                  ...
                  <input type="tel" id="phone" name="phone" placeholder="+91 XXXXX XXXXX" required maxlength="32">
              ...
              <div class="form-row">
                <div class="form-field">
                  ...
                  <input type="text" id="city" name="city" placeholder="e.g. Mumbai" required maxlength="80">
                  <span class="field-error" data-error-for="city"></span>
                </div>
                <div class="form-field">
                  <label for="state">State <span class="req" aria-hidden="true">*</span></label>
                  <input type="text" id="state" name="state" placeholder="e.g. Maharashtra" required maxlength="80">
              ...
              <div class="form-row hr-form-row-2col">
                <div class="form-field">
                  ...
                  <input type="text" id="pinCode" name="pinCode" placeholder="e.g. 400001" required maxlength="10">
              ...
              <div class="form-row">
                <div class="form-field">
                  ...
                  <input type="text" id="emergencyContactName" name="emergencyContactName" placeholder="Contact person name" required maxlength="100">
                ...
                <div class="form-field">
                  ...
                  <input type="text" id="emergencyContactRelationship" name="emergencyContactRelationship" placeholder="e.g. Father, Mother, Spouse" required maxlength="50">
              ...
              <div class="form-row hr-form-row-2col">
                <div class="form-field">
                  ...
                  <input type="tel" id="emergencyContactPhone" name="emergencyContactPhone" placeholder="Contact number" required maxlength="32">
            ...
            <div class="hr-step-card">
              ...
              <div class="form-row">
                ...
                <div class="form-field">
                  ...
                  <input type="number" id="graduationYear" name="graduationYear" placeholder="YYYY" required min="1950" max="2100">
            ...
            <div class="hr-step-card">
              ...
              <div class="form-row">
                <div class="form-field">
                  ...
                  <input type="text" id="bankAccountHolderName" name="bankAccountHolderName" placeholder="Name on passbook/cheque" required maxlength="120">
              ...
              <div class="form-row">
                <div class="form-field">
                  ...
                  <input type="text" id="accountNumber" name="accountNumber" placeholder="Bank account number" required maxlength="30">
                  <span class="field-error" data-error-for="accountNumber"></span>
                </div>
                <div class="form-field">
                  <label for="ifsc">IFSC <span class="req" aria-hidden="true">*</span></label>
                  <input type="text" id="ifsc" name="ifsc" placeholder="e.g. HDFC0000240" required maxlength="20">
              ...
              <div class="form-row">
                <div class="form-field">
                  ...
                  <input type="text" id="pan" name="pan" placeholder="10-digit PAN" required maxlength="20" class="hr-uppercase">
                  <span class="field-error" data-error-for="pan"></span>
                </div>
                <div class="form-field">
                  <label for="uanPfDetails">UAN / PF Details (if applicable)</label>
                  <input type="text" id="uanPfDetails" name="uanPfDetails" placeholder="12-digit UAN" maxlength="50">
            ...
            <div class="hr-step-card">
              ...
              <label class="hr-declaration-card">
                ...
                <span class="hr-decl-text">I acknowledge the applicable Arysec company policies. <span class="req" aria-hidden="true">*</span></span>
              </label>
